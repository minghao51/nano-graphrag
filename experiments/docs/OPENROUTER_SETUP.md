...
# View results
uv run python experiments/scripts/compare_results.py
```
...
1. ✅ Run quick test: `dotenvx run -- ./experiments/scripts/run_all_benchmarks_openrouter.sh --quick`
2. 📊 Compare results: `dotenvx run -- uv run python experiments/scripts/compare_results.py`
3. 🚀 Run full benchmark: `dotenvx run -- ./experiments/scripts/run_all_benchmarks_openrouter.sh`
