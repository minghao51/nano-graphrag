...
# 3. Run benchmarks:
./experiments/scripts/run_all_benchmarks_openrouter.sh --quick
```
...
./experiments/scripts/run_all_benchmarks.sh --quick
```
...
```bash
python experiments/scripts/compare_results.py
```
...
python -m bench --config experiments/configs/core/benchmark_multihop_rag.yaml

# MuSiQue (2,417 samples)
python -m bench --config experiments/configs/core/benchmark_musique.yaml

# HotpotQA (7,405 samples)
python -m bench --config experiments/configs/core/benchmark_hotpotqa.yaml

# 2WikiMHQA (12,576 samples)
python -m bench --config experiments/configs/core/benchmark_2wiki.yaml
```
...
**Example configs:**
- `experiments/configs/core/benchmark_adaptive.yaml`
- `experiments/configs/techniques/benchmark_adaptive.yaml`
- `experiments/configs/techniques/benchmark_hipporag.yaml`
- `experiments/configs/techniques/benchmark_hybrid.yaml`
- `experiments/configs/techniques/benchmark_raptor.yaml`
...
- `experiments/configs/*.yaml` are the runnable configs
- `experiments/scripts/run_all_benchmarks*.sh` are thin wrappers around those configs
- `experiments/scripts/compare_results.py` compares saved outputs under `./results/**`
...
```bash
uv sync
uv run python experiments/scripts/validate_setup.py
```
...
1. **Compare results**: `python experiments/scripts/compare_results.py`
